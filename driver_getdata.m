...
if isempty(my_field) == 1
    ...
    [dydt,bflowi,MRi,P,U,uprel,F,epi,v_feed_Glc_B,v_feed_TG_B] = cellfun(@(t,y) IFMod(t,y,sex,WR,ins0,glu0,c0,d0,tot_Glc_B,tot_TG_B,nmealsTot,lagm,tstart,tend),num2cell(T),num2cell(Y,2),'uni',0);
    ...
    [dydt,bflowi,MRi,P,U,uprel,F,epi,v_feed_Glc_B,v_feed_TG_B] = cellfun(@(t,y) IFMod(t,y,sex,WR,ins0,glu0,c0,d0,tot_Glc_B,tot_TG_B,nmealsTot,lagm,tstart,tend),num2cell(T.(my_field)),num2cell(Y.(my_field),2),'uni',0);
