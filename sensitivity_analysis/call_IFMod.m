%% FUNCTION DEFINITION
function [T,Y,ins0,glu0,c0,d0,tot_Glc_B,tot_TG_B,nmealsTot,lagm]=call_IFMod(t0,sex,WR,carbs,fats,ndays,lag,tstart,tend,sm,sa)
% ---------------------------------------------------------------------- 
...
d0=[2 350 4 8 9 2 18 250 2 1.8 250 2 1 120 2 2 12 2 45 8 2 1 10 2 2 480 4 1 280 4 0.2 4 2 ...
    22 350 2 38 350 2 2.2 350 2 1 90 2 2 1 2 90 0.6 2 1 2 2 5 400 3 17 80 2 1 130 4 0.5 4 2 ...
...
%Set ODEsolver Parameter Values
    ...
    for i=1:nmealsTot
     ...
     %simulation time
     tspan=t0:0.1:t1;
     [T{i},Y{i}] = ode15s(@(t,y) IFMod(t,y,sex,WR,ins0,glu0,c0,d0,tot_Glc_B,tot_TG_B,nmealsTot,lagm,tstart,tend,sm,sa),tspan,IC,options);
    end
    T=cell2mat(T);
    Y=cell2mat(Y);
end